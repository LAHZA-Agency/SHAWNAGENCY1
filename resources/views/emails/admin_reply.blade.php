...
<head>
    ...
    <title>Réponse de l'administrateur</title>
    <style>
        body,
        table,
        td,
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding-bottom: 16px;">
                                        <h1 style="color: var(--color-secondary); font-size: 24px; margin: 0;">Réponse de l'administrateur</h1>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom: 16px;">
                                ...
                                <tr>
                                    <td style="padding-bottom: 24px;">
                                        <p style="color: var(--color-primary); line-height: 1.5; margin: 0;">Vous avez reçu une réponse de l'administrateur à votre commentaire :</p>
                                        <p style="color: var(--color-primary); line-height: 1.5; margin: 0;"><strong>Votre commentaire :</strong> {{ $comment_content }}</p>
                                        <p style="color: var(--color-primary); line-height: 1.5; margin: 0;"><strong>Réponse de l'administrateur :</strong> {{ $reply_content }}</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
