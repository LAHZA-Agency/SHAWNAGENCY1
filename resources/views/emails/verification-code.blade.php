                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td style="padding-bottom: 16px;">
                                        <h1 style="color: var(--color-primary-dark); font-size: 24px; margin: 0;">Code de vérification</h1>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding-bottom: 16px;">
                                ...
                                <tr>
                                    <td style="padding-bottom: 24px;">
                                        <p style="color: var(--color-primary); line-height: 1.5; margin: 0;">Pour confirmer l'ajout de {{ $action }}, veuillez utiliser le code suivant :</p>
