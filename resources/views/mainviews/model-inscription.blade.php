...
<div class="max-w-4xl mx-auto">
    <h1 class="text-3xl font-semibold text-center ">Inscription à Shawn Agenc'y</h1>

    <p class="text-center  mt-2">Veuillez remplir vos coordonnées</p>

    <form action="{{ route('models.new-inscription') }}" method="POST" class="mt-8 space-y-6 required-password" enctype="multipart/form-data">
        @csrf
        ...
        <div class="flex gap-4 flex-col sm:flex-row">
            ...
            <div class="w-full sm:w-1/3">
                <x-input-label for="username" :value="__('Nom et prénom')" />
            ...
            <div class="w-2/5 sm:w-1/3">
                ...
                <div class="options flex flex-nowrap sm:flex-wrap gap-4 mt-1">
                    <label for="femme" class="relative flex items-center justify-start gap-2 hover:bg-primary px-4 py-[.35rem] rounded-lg cursor-pointer border-2 border-transparent transition-all duration-300 has-[:checked]:bg-primary-dark has-[:checked]:border-main/50">
                        ...
                        <span class="text-sm sm:text-base select-none transition-all duration-150 delay-[40ms] -translate-x-3 peer-checked/draft:text-main peer-checked/draft:-translate-x-1">
                            {{ __('Féminin') }}
                        </span>
                    </label>
                    <label for="homme" class="relative flex items-center justify-start gap-2 hover:bg-primary px-4 py-[.35rem] rounded-lg cursor-pointer border-2 border-transparent transition-all duration-300 has-[:checked]:bg-primary-dark has-[:checked]:border-main/50">
        ...
        <div class="flex gap-4 flex-wrap sm:flex-nowrap justify-between">
            ...
            <!-- Type Field -->
            <input type="hidden" name="model_type" checked value="Model" class="hidden peer/draft" />
        </div>
        ...
        <div class="flex gap-4 flex-col md:flex-row">
            ...
            <div class="w-full md:w-2/3">
                ...
                <div class="w-full gap-1 sm:gap-2 md:gap-8 flex justify-between md:justify-start flex-wrap">
                    <label for="sport_pratique"
                        class="relative hover:bg-primary-dark mb-2 flex items-center justify-start gap-2 px-4 py-[.35rem] rounded-lg cursor-pointer border-2 border-c-border transition-all duration-300 has-[:checked]:bg-primary-dark has-[:checked]:border-main/50">
                        ...
                        <span class="text-sm sm:text-base text-primary-300 select-none transition-all duration-150 delay-[40ms] -translate-x-4 peer-checked/sport_pratique:-translate-x-1 whitespace-nowrap">
                            Sport pratiqué
                        </span>
                    </label>
                    <label for="piercings"
                        class="relative mb-2 flex items-center justify-start gap-2 hover:bg-primary-dark px-4 py-[.35rem] rounded-lg cursor-pointer border-2 border-c-border transition-all duration-300 has-[:checked]:bg-primary-dark has-[:checked]:border-main/50">
                        ...
                        <span class="text-sm sm:text-base text-primary-300 select-none transition-all duration-150 delay-[40ms] -translate-x-4 peer-checked/piercings:-translate-x-1 whitespace-nowrap">
                            Piercings
                        </span>
                    </label>
                    <label for="tatouages"
                        ...
                        <span class="text-sm sm:text-base text-primary-300 select-none transition-all duration-150 delay-[40ms] -translate-x-4 peer-checked/tatouages:-translate-x-1 whitespace-nowrap">
                            Tatouages
                        </span>
                    </label>
                </div>
