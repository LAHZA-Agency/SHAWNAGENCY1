...
return [
    ...
    | à ajuster ces messages ici selon vos besoins.
    |
    */
    ...
    'ascii' => 'Le champ :attribute ne peut contenir que des caractères alphanumériques et symboles en un seul octet.',
    ...
    | pour une règle donnée d'attribut.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Les lignes suivantes sont utilisées pour échanger notre espace réservé
    | d'attribut par quelque chose de plus convivial tel que "Adresse E-Mail"
    | au lieu de "email". Cela nous aide à rendre notre message plus clair.
    |
    */
